return {
  ...
  config = function()
    ...
    local on_attach = function(client, bufnr)
      ...
      keymap.set("n", "<leader>d", vim.diagnostic.open_fload, opts) -- show diagnostics for line

      opts.desc = "Go to previous diagnositc"
    ...
    lspconfig["lua_ls"].setup({
      ...
      settings = {
        Lua = {
          -- make the launguage server recognize "vim" global
          diagnostics = {
            globals = { "vim" }
          },
          workspace = {
